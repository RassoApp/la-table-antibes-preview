...
function V3LanguageSwitcher({ basePath, lang, locale, open, onToggle, onClose }) {
    ...
    <div className={`v3-language ${open ? 'is-open' : ''}`}>
      ...
      <div className="v3-language__menu" aria-label={locale.uiLabels.languageSwitcher}>
        {supportedLanguages.map((code) => (
          <NavLink
            key={code}
            className={({ isActive }) => `v3-language__item ${isActive && code === lang ? 'is-active' : ''}`}
...
export function V3Layout({ lang, locale, basePath }) {
  const location = useLocation();
      ...
      <footer className="v3-footer">
        <div className="v3-footer__inner">
          ...
          <div className="v3-footer__cols">
            ...
            <div>
              <span className="v3-footer__title">Compare</span>
              <NavLink to="/v1/fr">Version 1</NavLink>
              <NavLink to="/v2/fr">Version 2</NavLink>
              <NavLink to="/v3/fr">Version 3</NavLink>
            </div>
          </div>
        </div>
      </footer>
