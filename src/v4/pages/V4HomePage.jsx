        ...
        <div className="v3-container">
          ...
          <div className="v3-menu-teaser">
            ...
            <article className="v3-menu-teaser__card">
              <div>
                <span className="v3-kicker">{locale.menuPage.categories.find((category) => category.id === 'mains')?.title}</span>
                <h3>{featuredMain?.name}</h3>
                <p>{featuredMain?.description}</p>
              </div>
              <Link className="v3-button v3-button--ghost-light" to={buildLocalizedPath('menu')}>
                {locale.actions.menu}
              </Link>
            </article>
          </div>
        ...
        <div className="v3-container v3-grid v3-grid--atmosphere">
          ...
          <div className="v3-stack">
            ...
            <div className="v3-stack__offset">
              <ImageCard
                src={v3Media.interiorSunlit}
                alt="Salle ensoleillee"
                caption="Salle lumineuse"
                kicker={locale.brand.district}
              />
            </div>
          </div>
        ...
        <div className="v3-container v3-grid v3-grid--contact">
          <div className="v3-copy">
            ...
            <div className="v3-button-row">
              ...
              <a
                className="v3-button v3-button--secondary-dark"
